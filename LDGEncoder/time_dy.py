...
# data_path = "./LDGEncoder/datasets/TEGs_mining(2k).npz"
# data_path = "./LDGEncoder/datasets/TEGs_fishing(2k).npz"
data_path = "./LDGEncoder/datasets/TEGs_phishing_new(2k).npz"
# data_path = "./LDGEncoder/datasets/TEGs_exchange_new(2k).npz"
# data_path = "./LDGEncoder/datasets/TEGs_mining_new(2k).npz"
...
# Dynamic_Gset = con_dynamic_Gset(all_node_path, data_path, args.batch_size, args.max_links, max_n=args.max_links)
...
# The total number of partitioned train-test validation batches
# exchange 28 14 4
# ICO 19 9 3
# mining 7 3 1
# phishing 146 73 24
