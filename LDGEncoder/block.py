...
def train_phishing_detector_dy(train_dataset, model, train_num, val_num, test_num, args, val_dataset=None, test_dataset=None, writer=None):
    ...
    for epoch in range(args.num_epochs):
        ...
        #
        # df.to_csv(r'.\LDGEncoder\datasets\exchanghe\ico_p3_train_result.csv', mode='a', index=False)
        ...
        if val_dataset is not None:
            ...
            if val_result['acc'] > best_val_result['acc'] - 1e-7:
                ...
                if val_result['acc'] > best_val_result['acc'] - 1e-7:
                    ...
                    torch.save(best_model_state, './LDGEncoder/model_param/TEGD.pth')
...
def evaluate_dynamic(dataset, batch_num, model, args, name='Validation', max_num_examples=None):
    ...
    # df.to_csv(r'.\LDGEncoder\datasets\exchanghe\ico_p3_valandtest_result.csv',
    #           mode='a', index=False)
