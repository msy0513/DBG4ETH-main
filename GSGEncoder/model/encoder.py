...
class HGATE_encoder(torch.nn.Module):
    ...
    def __init__(self, in_channels: int, hidden_channels: int, out_channels: int, num_layers: int,
        ...
        # in_channels： feature dimension of the node vector, out_channels: feature dimension after GAT
    ...
    def forward(self, x, edge_index, batch, edge_attr=None):
        ...
        # x is the node representation and z is the graph representation
        return x, z
